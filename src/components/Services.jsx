...
const Services = () => {
    ...
    const handelShow = (index)=>{
        let i = document.querySelector(`.services .i-${index}`)
        let p = document.querySelector(`.services .p-${index}`)
    ...
    <section className="services">
        ...
        <div className="container">
            ...
            <div className="Serv0-boxes">
                {Serv0.map((e,index)=> (
                    <div className="box" key={index} data-aos="fade-up" data-aos-delay={`${index}0`} >
                        <div className="group"> <div className="h3"> {e.h3} </div> <i onClick={_=>handelShow(index)} className={`bx bx-plus i-${index}`}></i>  </div>
            ...
            <div className="Serv1-boxes">
                {Serv1.map((e,index)=> (
                    <div className="box" key={index} data-aos="fade-up" data-aos-delay={`${index}0`}  >
                        <div className="group"> <div className="h3"> {e.h3} </div> <i onClick={_=>handelShow(index + 15)} className={`bx bx-plus i-${index + 15}`}></i>  </div>
            ...
            <div className="Serv2-boxes">
                {Serv2.map((e,index)=> (
                    <div className="box" key={index} data-aos="fade-up" data-aos-delay={`${index}0`}  >
                        <div className="group"> <div className="h3"> {e.h3} </div> <i onClick={_=>handelShow(index + 30)} className={`bx bx-plus i-${index + 30}`}></i>  </div>
